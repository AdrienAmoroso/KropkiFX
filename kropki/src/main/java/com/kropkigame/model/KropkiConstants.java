...
public interface KropkiConstants {
        ...
        String NUMBER_BAR_STYLE = "-fx-border-color: white; -fx-border-width: 2px; -fx-padding: 10px;"; // Style de la
                                                                                                        // numberBar
                                                                                                        // (sélection
                                                                                                        // des nombres)
        String NUMBER_BUTTON_STYLE = "-fx-background-color: #000000, linear-gradient(#7ebcea, #2f4b8f), linear-gradient(#426ab7, #263e75), "
                ...
                + "-fx-pref-width: 50px; -fx-pref-height: 50px; -fx-font-weight: bold; -fx-border-color: white; -fx-border-radius: 3"; // Style
                                                                                                                                        // des
                                                                                                                                        // boutons
                                                                                                                                        // de
                                                                                                                                        // sélection
        ...
        String NUMBER_BUTTON_HOVER_STYLE = "-fx-background-color: #000000, linear-gradient(#7ebcea, #2f4b8f), linear-gradient(#426ab7, #263e75), "
                ...
                + "-fx-effect: dropshadow(gaussian, white, 5, 0.3, 0, 0);"; // Style de survol des boutons de
                                                                                // sélection des nombres
        String HELP_TEXT_STYLE = "-fx-font-family: Helvetica; -fx-font-weight: bold;"; // Style du texte d'aide (switch)

        String CELL_TEXT_STYLE = "-fx-fill: white; -fx-font-family: Helvetica; -fx-font-size: 20pt; -fx-font-weight: bold;"; // Style
                                                                                                                                // de
                                                                                                                                // texte
                                                                                                                                // pour
                                                                                                                                // les
                                                                                                                                // cellules
        String CELL_BORDER_STYLE = "-fx-border-color: white; -fx-border-width: 1px;"; // Style de bordure pour les
                                                                                        // cellules
        String CELL_ERROR_STYLE = "-fx-border-color: red; -fx-border-width: 3px; -fx-border-style: solid;"; // Style de
                                                                                                                // la
                                                                                                                // cellule
                                                                                                                // lorsqu'elle
                                                                                                                // est
                                                                                                                // incorrecte
        String CELL_SELECTED_STYLE = "-fx-border-color: white; -fx-border-width: 1px; -fx-background-color: blue;"; // Style
                                                                                                                        // de
                                                                                                                        // la
                                                                                                                        // cellule
                                                                                                                        // lorsqu'elle
                                                                                                                        // est
                                                                                                                        // sélectionnée
        String CELL_ERROR_SELECTED_STYLE = "-fx-border-color: red; -fx-border-width: 3px; -fx-border-style: solid; -fx-background-color: blue;"; // Style
                                                                                                                                                // de
                                                                                                                                                // la
                                                                                                                                                // cellule
                                                                                                                                                // lorsqu'elle
        ...
        String RESET_BUTTON_STYLE = "-fx-background-color: transparent; -fx-border-color: white; -fx-border-radius: 10;"; // Style
                                                                                                                        // du
                                                                                                                        // bouton
                                                                                                                        // de
                                                                                                                        // réinitialisation
        String RESET_BUTTON_HOVER_STYLE = "-fx-effect: dropshadow(gaussian, white, 3, 0.3, 0, 0);" // Style de survol du
                                                                                                // bouton de
                                                                                                // réinitialisation
                + "-fx-background-color: transparent; -fx-border-color: white; -fx-border-width: 1; -fx-border-style: solid; -fx-border-radius: 10;";

        String BACK_BUTTON_STYLE = "-fx-background-color: transparent; -fx-border-color: white; -fx-border-radius: 10;"; // Style
                                                                                                                        // du
                                                                                                                        // bouton
                                                                                                                        // de
                                                                                                                        // réinitialisation
        String BACK_BUTTON_HOVER_STYLE = "-fx-effect: dropshadow(gaussian, white, 3, 0.3, 0, 0);" // Style de survol du
                                                                                                // bouton de
                                                                                                // réinitialisation
                + "-fx-background-color: transparent; -fx-border-color: white; -fx-border-width: 1; -fx-border-style: solid; -fx-border-radius: 10;";

        String TIMER_LABEL_STYLE = "-fx-font-family: 'Digital-7'; -fx-font-size: 40pt; -fx-text-fill: white;"; // Style
                                                                                                                // du
                                                                                                                // chronomètre
        ...
        String LABEL_TIMER_FONT_PATH = "kropki\\assets\\fonts\\digital-7.ttf"; // Chemin vers la police du chronomètre
}