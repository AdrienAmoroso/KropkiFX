...
public class DifficultySelectionMenu extends Parent {
    ...
    public DifficultySelectionMenu(SceneSwitcher sceneSwitcher) {
        ...
        Button fourButton = createImageButton(
                ...
                150,
                100,
                e -> showLevelSelection("4x4"));
        Button fiveButton = createImageButton(
                "Difficulty\\5x5",
                150,
                100,
                e -> showLevelSelection("5x5"));
        Button sixButton = createImageButton(
                "Difficulty\\6x6",
                150,
                100,
                e -> showLevelSelection("6x6"));
        Button sevenButton = createImageButton(
                "Difficulty\\7x7",
                150,
                100,
                e -> showLevelSelection("7x7"));
        Button eightButton = createImageButton(
                "Difficulty\\8x8",
                150,
                100,
                e -> showLevelSelection("8x8"));

        Button homeButton = createImageButton("Home", 120, 70,  e -> sceneSwitcher.switchToFirstMenu());
    ...
    private void showLevelSelection(String difficulty) {
        // TODO: Implémenter la logique pour montrer l'écran de sélection du niveau
    }
}
